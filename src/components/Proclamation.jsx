...
const paragraphs = [
  ...
  'Now, therefore, we proclaim November as AI Literacy Month and November 30 as AI Literacy Day.',
];
  ...
  return (
    <section id="proclamation" className="section-pad">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.78fr_1.22fr] lg:px-8">
        <SectionTitle eyebrow="Proclamation Center" title="Sample Proclamation: AI Literacy Month" align="left">
